...
CFLAGS_PYEMBED = ['-march=nocona', '-mtune=haswell', '-ftree-vectorize', '-fPIC', '-fstack-protector-strong', '-fno-plt', '-O3', '-ffunction-sections', '-fdebug-prefix-map=/tmp/build/80754af9/python_1553721932202/work=/usr/local/src/conda/python-3.7.3', '-fdebug-prefix-map=/home/harshith/anaconda3=/usr/local/src/conda-prefix', '-fuse-linker-plugin', '-ffat-lto-objects', '-flto-partition=none', '-flto', '-fwrapv', '-O3']
CFLAGS_cshlib = ['-fPIC']
COMPILER_CC = 'gcc'
COMPILER_CXX = 'g++'
CPPPATH_ST = '-I%s'
...
CXXFLAGS_PYEMBED = ['-march=nocona', '-mtune=haswell', '-ftree-vectorize', '-fPIC', '-fstack-protector-strong', '-fno-plt', '-O3', '-ffunction-sections', '-fdebug-prefix-map=/tmp/build/80754af9/python_1553721932202/work=/usr/local/src/conda/python-3.7.3', '-fdebug-prefix-map=/home/harshith/anaconda3=/usr/local/src/conda-prefix', '-fuse-linker-plugin', '-ffat-lto-objects', '-flto-partition=none', '-flto', '-fwrapv', '-O3']
...
EXAMPLE_DIRECTORIES = ['error-model', 'naming', 'realtime', 'tcp', 'matrix-topology', 'udp', 'ipv6', 'socket', 'udp-client-server', 'tutorial', 'wireless', 'stats', 'routing', 'energy', 'traffic-control']
...
INCLUDES_PYEMBED = ['/home/harshith/anaconda3/include/python3.7m']
INFODIR = '/usr/local/share/info'
INT64X64_USE_128 = 1
LIBDIR = '/usr/local/lib'
LIBEXECDIR = '/usr/local/libexec'
LIBPATH_PYEMBED = ['/home/harshith/anaconda3/lib/python3.7/config-3.7m-x86_64-linux-gnu', '/home/harshith/anaconda3/lib']
LIBPATH_ST = '-L%s'
LIB_BOOST = []
LIB_GTK = ['gtk-3', 'gdk-3', 'pangocairo-1.0', 'pango-1.0', 'atk-1.0', 'cairo-gobject', 'cairo', 'gdk_pixbuf-2.0', 'gio-2.0', 'gobject-2.0', 'glib-2.0']
LIB_LIBXML2 = ['xml2']
LIB_PYEMBED = ['python3.7m', 'crypt', 'pthread', 'dl', 'util', 'rt', 'm', 'python3.7m', 'crypt', 'pthread', 'dl', 'util', 'rt', 'm']
LIB_RT = ['rt']
LIB_SQLITE3 = ['sqlite3']
LIB_ST = '-l%s'
...
NS3_EXECUTABLE_PATH = ['/home/harshith/ns-allinone-3.30.1/ns-3.30.1/build/src/fd-net-device', '/home/harshith/ns-allinone-3.30.1/ns-3.30.1/build/src/tap-bridge']
...
NS3_MODULE_PATH = ['/usr/lib/gcc/x86_64-linux-gnu/7', '/home/harshith/ns-allinone-3.30.1/ns-3.30.1/build/lib']
...
PYO = 1
PYTAG = 'cpython-37'
PYTHON = ['/home/harshith/anaconda3/bin/python3']
PYTHONARCHDIR = '/usr/local/lib/python3.7/site-packages'
PYTHONDIR = '/usr/local/lib/python3.7/site-packages'
PYTHON_CONFIG = ['/home/harshith/anaconda3/bin/python3-config']
PYTHON_VERSION = '3.7'
...
cfg_files = ['/home/harshith/ns-allinone-3.30.1/ns-3.30.1/build/ns3/config-store-config.h', '/home/harshith/ns-allinone-3.30.1/ns-3.30.1/build/ns3/core-config.h']
cprogram_PATTERN = '%s'
